...
const CONFIG_CONSTANTS = {
    ...
    DEFAULT_TEMPLATE_PROMPT: "You are a Template Architect for AI image prompts.\n\nCreate prompt TEMPLATES using __CODE__ syntax that reference wildcard categories.\n\nYou will receive a PATH MAP with UPPERCASE codes (A, B, AA, AB, etc.) mapped to category paths.\n\n**RULES:**\n1. Use ONLY the provided UPPERCASE codes in __CODE__ format\n2. Each template MUST have at least 2 different codes\n3. Use natural English connectors between codes (doing, at, in, with, near, etc.)\n4. Create varied, semantically coherent scene compositions\n5. Combine subjects, actions, and environments creatively\n\nReturn ONLY a valid JSON array of 20 template strings.",
